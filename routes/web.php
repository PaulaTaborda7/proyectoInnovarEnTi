...
Route::group(['middleware' => ['solodocente']], function () {
    ...
    Route::get('/habilitar-recurso-educativo-digital/{idRed}/{idGrupo}/{bandera1}/{bandera2}',[RedController::class,'habilitarRecurso'])->name('habilitar.recurso.educativo.digital');
    Route::get('/deshabilitar-recurso-educativo-digital/{idRed}/{idGrupo}/{bandera1}/{bandera2}',[RedController::class,'deshabilitarRecurso'])->name('deshabilitar.recurso.educativo.digital');
