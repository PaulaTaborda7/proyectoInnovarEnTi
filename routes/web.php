...
Route::group(['middleware' => ['solodocente']], function () {
    ...
    Route::get('/deshabilitar-recurso-educativo-digital/{idRed}/{idGrupo}/{bandera}',[RedController::class,'deshabilitarRecurso'])->name('deshabilitar.recurso.educativo.digital');
