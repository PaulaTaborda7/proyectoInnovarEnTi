        ...
        <main>
            <div class="container" style="background-color: #F1FEFE">
                ...
                <div class="d-flex justify-content-center">
                    <a href="/login" class="ml-4 text-sm text-color: primary"><button class="btn btn-outline-info"><img src="images/admin.png" height ="100" width="100"/> <br> ADMINISTRADOR</button></a>
